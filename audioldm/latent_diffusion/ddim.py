...
class DDIMSampler(object):
    ...
    def sample(
        ...
        **kwargs,
        ...
        # print(f"ddim sampling {conditioning.keys()}") # here yes
        # input()
    ...
    def ddim_sampling(
        ...
        # print(f"first ddim sampling {cond.keys()}") # here yes
        # input()
    ...
    def p_sample_ddim(
        ...
        # print(f"p_sample_ddim sampling {c.keys()}") # here yes
        # input()

        if unconditional_conditioning is None or unconditional_guidance_scale == 1.0: # no
