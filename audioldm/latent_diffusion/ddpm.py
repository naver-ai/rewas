...
from audioldm.utilities.model_util import (default, count_params, exists)
from encoder.encoder_utils import instantiate_from_config

from audioldm.diffusionmodules.ema import LitEma
...
class LatentDiffusion(DDPM):
    ...
    def filter_useful_cond_dict(self, cond_dict):
        ...
        for key in cond_dict.keys(): # crossattn, concat
