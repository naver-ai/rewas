# reference: https://github.com/haoheliu/AudioLDM-training-finetuning
...
from audioldm.diffusionmodules.ema import *

from audioldm.diffusionmodules.model import Encoder, Decoder
from audioldm.diffusionmodules.distributions import (
    DiagonalGaussianDistribution,
)
from encoder.encoder_utils import instantiate_from_config
from audioldm.utilities.model_util import get_vocoder
from audioldm.utilities.tools import synth_one_sample
...
class AutoencoderKL(pl.LightningModule):
    def __init__(
        ...
        if self.image_key == "fbank":
            self.vocoder = get_vocoder(None, "cpu", ddconfig["hifigan_ckpt"])
